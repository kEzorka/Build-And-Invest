...
void RealEstateAgency::makeStandardHouses() {
...
House* RealEstateAgency::buyHouse(Player* player, const HouseType& house_type) {
...
Supermarket* RealEstateAgency::buySupermarket(Player* player) {
	int64_t building_cost;
	int64_t player_money = player->getMoney();
